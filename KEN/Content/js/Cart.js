...
function draftorder()
{
    var total = $("#allItemTotalPrice").text();
    var totalprice = parseInt(total.substring(1));
    $.ajax({
        method: 'POST',
        url: '/Design/DraftOrdersDetail',
