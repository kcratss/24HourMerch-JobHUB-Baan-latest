<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ValueConversionReport.aspx.cs" Inherits="KEN.Reports.ValueConversionReport" %>
    ...
    <form id="form1" runat="server">
      <asp:HiddenField ID="hdndate" runat="server" />
        ...
        <div style="margin-top: 20px;">
            ...
            <rsweb:ReportViewer ID="ValueConversionReportViewer" runat="server" Width="100%" Height="800px"></rsweb:ReportViewer>
        </div>
