<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyPaymentReport.aspx.cs" Inherits="KEN.Reports.DailyPaymentReport" %>
...
<head runat="server">
    ...
    <script>
        $(function () {
            ...
            //var showdate = parseInt(CurrDate.getDate()) - 1;
            //showdate = showdate.toString();

            //showdate = ('00' + showdate).substr(-2) + '/' + ('00' + (CurrDate.getMonth() + 1)).substr(-2) + '/' + CurrDate.getFullYear();

            //$("#txtdate").val(showdate);
            //getreport();
        }
        );
        ...
        //function getreport() {
        //    if ($("#txtdate").val() != "") {
        //        var paydate = GetDate($("#txtdate").val());
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="row">
            ...
            <label style="margin-top: 10px;margin-left: 10px;font-size: 20px;">Payment Date</label> 
            </div>
            <div class="col-lg-2" style="width:140px">
            <asp:TextBox ID="txtdate" runat="server" style="margin-top:10px;width:110px"></asp:TextBox>
            </div>
    ...
    <div style="margin-top:20px;">
        ...
        <rsweb:ReportViewer ID="DailyPaymentReportReportViewer" runat="server" Width="100%" Height="800px"></rsweb:ReportViewer>
    </div>
    </form>
</body>
</html>
