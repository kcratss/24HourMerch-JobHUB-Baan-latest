...
namespace KEN.Reports
{
    ...
    public partial class OpportunityValueConversionReport : System.Web.UI.Page
    {
        ...
        public void GeneratedReport(string tdate, string fdate, string source)
        {
            ...
            OpportunityValueConversionReportViewer.Visible = true;
            OpportunityValueConversionReportViewer.LocalReport.Refresh();
            OpportunityValueConversionReportViewer.ProcessingMode = ProcessingMode.Local;

            var currentuser = DataBaseCon.ActiveUser();
            var ReportData = dbContext.Pro_OppValueConversionReport(fdate, tdate, source).ToList();

            OpportunityValueConversionReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/OpportunityValueConversionReport.rdlc");
            OpportunityValueConversionReportViewer.LocalReport.DataSources.Clear();
            ...
            this.OpportunityValueConversionReportViewer.LocalReport.SetParameters(new ReportParameter[] { sourceParameter, currentdateParameter, fromdateParameter, todateparameter });


            OpportunityValueConversionReportViewer.LocalReport.DataSources.Add(rds);
            OpportunityValueConversionReportViewer.LocalReport.Refresh();
            OpportunityValueConversionReportViewer.DataBind();
        }
