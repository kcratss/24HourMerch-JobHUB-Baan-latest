<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpportunityValueConversionReport.aspx.cs" Inherits="KEN.Reports.OpportunityValueConversionReport" %>
    ...
    <form id="form2" runat="server">
      <asp:HiddenField ID="hdndate" runat="server" />
        ...
        <div style="margin-top: 20px;">
            ...
            <rsweb:ReportViewer ID="OpportunityValueConversionReportViewer" runat="server" Width="100%" Height="800px"></rsweb:ReportViewer>
        </div>
