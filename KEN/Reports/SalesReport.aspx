<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesReport.aspx.cs" Inherits="KEN.Reports.SalesReport" %>
...
<body>
    <form id="form1" runat="server">
        <div class="row">
            <label class="lblheader" style="margin-left: 24px;">Sales Report</label>
        </div>
        ...
        <div class="row" style="margin-left:-4px;margin-top:15px;">
            <div class="col-lg-2" style="width:120px;">
                ...
                <asp:Label AssociatedControlID="today" ID="lbltoday" runat="server" style="font-size:16px">&nbsp;Today</asp:Label>
            </div>
            <div class="col-lg-2" style="width:200px;">
                <asp:CheckBox ID="Week" runat="server" CssClass="DateType"   style=""/>
                <asp:Label AssociatedControlID="Week" ID="lblweek" runat="server" style="font-size:16px">&nbsp;Current Week</asp:Label>
            </div>
            <div class="col-lg-2" style="width:200px;">
                <asp:CheckBox ID="Month" runat="server" CssClass="DateType"   style=""/>
                <asp:Label AssociatedControlID="Month" ID="lblmonth" runat="server" style="font-size:16px">&nbsp;Current Month</asp:Label>
            </div>
            <div class="col-lg-2" style="width:200px;">
                <asp:CheckBox ID="quarter" runat="server" CssClass="DateType"   style=""/>
                <asp:Label AssociatedControlID="quarter" ID="lbl6month" runat="server" style="font-size:16px">&nbsp;Current Quarter</asp:Label>
            </div>
            <div class="col-lg-2" style="width:200px;">
                <asp:CheckBox ID="year" runat="server" CssClass="DateType"   style=""/>
                <asp:Label AssociatedControlID="year" ID="lblyear" runat="server" style="font-size:16px">&nbsp;Current Year</asp:Label>
            </div>
        </div>

    <div class="row">
        <div class="col-lg-1" style="width:130px;">
            <label class="lblFromstyle" style="margin-left: 10px;">From</label>
        </div>
        <div class="col-lg-1">
    ...
    <div style="margin-top:20px;">
        ...
        <rsweb:ReportViewer ID="SalesReportReportViewer" runat="server" Width="100%" Height="800px"></rsweb:ReportViewer>    
    </div>
    </form>
</body>
</html>
