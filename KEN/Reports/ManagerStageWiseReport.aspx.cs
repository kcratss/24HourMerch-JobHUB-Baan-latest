...
{
    public partial class ManagerStageWiseReport : System.Web.UI.Page
    {
        ...
        public void GeneratedReport(string tdate,string fdate,string source)
        {
            ...
            ManagerStageWiseReportViewer.Visible = true;
            ManagerStageWiseReportViewer.LocalReport.Refresh();
            ManagerStageWiseReportViewer.ProcessingMode = ProcessingMode.Local;

            var currentuser = DataBaseCon.ActiveUser();

            var ReportData = dbContext.Pro_ManagerStageWiseReport(fdate, tdate, source).ToList();
          
            ManagerStageWiseReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/ManagerStageWiseReport.rdlc");
            ManagerStageWiseReportViewer.LocalReport.DataSources.Clear();
            ...
            this.ManagerStageWiseReportViewer.LocalReport.SetParameters(new ReportParameter[] { sourceParameter, currentdateParameter,fromdateParameter, todateparameter });


            ManagerStageWiseReportViewer.LocalReport.DataSources.Add(rds);
            ManagerStageWiseReportViewer.LocalReport.Refresh();
            ManagerStageWiseReportViewer.DataBind();
        }
